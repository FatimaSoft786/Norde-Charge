        ...
        <div className=" flex w-full flex-col items-center gap-4">
          ...
          <div className=" flex flex-col items-center gap-[54px] self-stretch sm:gap-[72px]">
            <p className=" text-[20px] sm:text-[17px] self-stretch text-center !font-light text-white leading-[190%] mx-[110px] sm:mx-0">
             Experience rapid, reliable, and eco-friendly EV charging with our state-of-the-art technology, designed for both home and commercial use. Transform your electric vehicle experience with unmatched efficiency and convenience.
            </p>
          </div>
