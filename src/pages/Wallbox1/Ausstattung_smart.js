...
const Ausstattung_smart = () => {
 ...
 <div className=' flex flex-col justify-center items-center mt-4'>
    <p className=' text-[34px] sm:text-[24px] font-semibold text-black'>Ausstattung Smart</p>
    <div className=' h-[3px] sm:h-[2px] w-[23%] sm:w-[42%] bg-black'></div>
     </div>
...
export default Ausstattung_smart