...
const QualityComponent = () => {
 ...
 <div className=' flex flex-col justify-start items-start mt-4 ml-[70px]'>
    <p className=' text-[34px] sm:text-[24px] font-semibold text-black'>High-quality components</p>
    <div className=' h-[3px] sm:h-[2px] w-[44%] sm:w-[50%] bg-black'></div>
   <p className=' !font-regular text-[18px] opacity-50 text-black mt-3'>The optionally configurable sockets and switches are weatherproof (IP44), making them ideal for outdoor use.</p>
     </div>
   </div>
