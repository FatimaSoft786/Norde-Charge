...
const Ladepunktstatus = () => {
 ...
 <div className=' flex flex-col justify-start items-start mt-4 ml-[70px]'>
   ...
   <p className=' !font-regular text-[18px] opacity-50 text-black mt-3'>Mit der übersicht­lichen Status­anzeige zu jedem eingebundenen Lade­punkt haben Sie Ihren Ladepark immer im Blick. Abhängig von der Ausführung des Ladepunkts stellt Ihnen die eCC App in Echt­zeit die verfügbaren Infor­mationen zum Lade­vorgang zur Verfügung.</p>
     </div>
   </div>
...
export default Ladepunktstatus