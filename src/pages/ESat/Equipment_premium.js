...
const Equipment_base = () => {
 ...
 <div className=' flex flex-col justify-center items-center mt-4'>
    <p className=' text-[34px] font-semibold text-black'>Equipment premium</p>
    <div className=' h-[3px] w-[25%] bg-black'></div>
     </div>
...
<p className=' text-center py-2 text-[18px] font-semibold'>11 kw</p>
     ...
     <img className=' w-[40%] h-auto' src={premium} alt='premium'/>
