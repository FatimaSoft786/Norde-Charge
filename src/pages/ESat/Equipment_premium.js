...
import premium from "../../images/equipment_premium.svg"
...
const Equipment_base = () => {
 ...
 <div className=' flex flex-col justify-center items-center mt-4'>
    <p className=' text-[34px] sm:text-[24px] font-semibold text-black'>Equipment premium</p>
    <div className=' h-[3px]  sm:h-[2px] w-[25%] sm:w-[52%] bg-black'></div>
     </div>
...
<p className=' text-center py-2 text-[18px] font-semibold'>11 kw</p>
     ...
     <img className=' w-[40%] sm:w-[90%] sm:mt-3 h-auto' src={premium} alt='premium'/>
