...
const Equipment_smart = () => {
 ...
 <div className=' flex flex-col justify-center items-center mt-4'>
    <p className=' text-[34px] font-semibold text-black'>Equipment Smart</p>
    <div className=' h-[3px] w-[20%] bg-black'></div>
     </div>

   <div className=' flex flex-row'>
   <div className=' w-[40%] h-auto justify-center items-center'>
<img className=' w-full  items-center' src={smart} alt='base'/>
   </div>
   <div className=' w-[55%] flex flex-col mt-11'>
  {
    data.map((e)=>(
