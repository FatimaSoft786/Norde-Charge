...
const HomeBanner3 = () => {
  return (
    ...
    <span className=' flex text-center sm:w-full h-auto text-white text-[16px] font-normal mt-[5px]'>Wrap your garden, terrace or entrance area in a very spacial ambience.
    </span>
